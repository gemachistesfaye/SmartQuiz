            ...
            >
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button 
                  ...
                  className="w-full bg-white/5 hover:bg-white/10 border border-white/10 text-white py-4 rounded-2xl font-bold transition-all flex items-center justify-center gap-3 min-h-[48px]"
                >
